...
//				case _T('D'):
//					BufferPrintf(_T("%s"), GetDateString());
//					break;

				case _T('E'):
					BufferPutChar (_T('\x1B'));
					break;
...
//				case _T('T'):
//					BufferPrintf(_T("%s"), GetTimeString());
//					break;
//
//				case _T('V'):
...
//								BufferPrintf (_T("Windows 98"));
//							else
//								BufferPrintf (_T("Windows 95"));
//							break;
//
//
//						case VER_PLATFORM_WIN32_NT:
//							BufferPrintf (_T("Windows NT Version %lu.%lu"),
