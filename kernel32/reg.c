        ...
        do
        {
            ...
            for (;;)
            {
                ...
                if (NT_SUCCESS(Status2))
                {
                    ...
                    ValueName.Length = (USHORT)Info.KeyValue->NameLength;
            ...
            for (;;)
            {
                ...
                if (NT_SUCCESS(Status2))
                {
                    ...
                    /* don't use RtlInitUnicodeString as the string is not NULL-terminated! */
                    SubKeyName.Length = (USHORT)Info.KeyNode->NameLength;
                    SubKeyName.MaximumLength = SubKeyName.Length;
                    SubKeyName.Buffer = Info.KeyNode->Name;
                    ClassName.Length = (USHORT)Info.KeyNode->ClassLength;
                ...
                DWORD *lpdwDisposition)
{
  ...
  LocalKeyHandle = NULL;
    ...
    while (TRUE)
    {
        ...
        Length = wcslen (LocalKeyName.Buffer);
        LocalKeyName.Length = (USHORT)Length * sizeof(WCHAR);
    ...
    else
    {
        if (lpClass == NULL)
        {
            ...
            else
            {
                ...
                StringU.Length = (USHORT)KeyInfo->Basic.NameLength;
                StringU.MaximumLength = (USHORT)KeyInfo->Basic.NameLength;
            }
        }
        else
        {
            ...
            else
            {
                ...
                StringA.Length = 0;
                StringA.MaximumLength = (USHORT)*lpcbClass;
                StringU.Buffer = (PWCHAR)((ULONG_PTR)KeyInfo->Node.Name + KeyInfo->Node.ClassOffset);
                StringU.Length = (USHORT)KeyInfo->Node.ClassLength;
                StringU.MaximumLength = (USHORT)KeyInfo->Node.ClassLength;
                ...
                *lpcbClass = StringA.Length;
                ...
                StringU.Length = (USHORT)KeyInfo->Node.NameLength;
                StringU.MaximumLength = (USHORT)KeyInfo->Node.NameLength;
            }
        }
        ...
        if (ErrorCode == ERROR_SUCCESS)
        {
            ...
            StringA.Length = 0;
            StringA.MaximumLength = (USHORT)*lpcbName;
            RtlUnicodeStringToAnsiString (&StringA, &StringU, FALSE);
                 ...
                 PFILETIME lpftLastWriteTime)
{
    ...
    if ((ErrorCode == ERROR_SUCCESS) && (lpClass != NULL))
    {
        ...
        AnsiString.Length = 0;
        UnicodeString.Length = (USHORT)*lpcbClass * sizeof(WCHAR);
                 ...
                 LPDWORD lpcbData)
{
    ...
    {
        ValueData.Length = 0;
        ValueData.MaximumLength = (USHORT)(*lpcbData + 1) * sizeof(WCHAR);
               ...
               DWORD cbData)
{
    ...
    if (is_string(dwType) && (cbData != 0))
    {
        ...
        AnsiString.Length = (USHORT)(cbData + bNoNulledStr);
        AnsiString.MaximumLength = (USHORT)(cbData + bNoNulledStr);
